console.log("Libros del ejercicio 1.");
...
let taco = {
  tamaño: "Grande",
  tipo: "Pastor",
  ingredientes: ["Cartina", "Cilantro"],
  recomiendo_salsa: true,
  precio: 6
};

let taco_json = JSON.stringify(taco);
console.log(taco_json);

let str_json = '{"Nombre": Dion, "Nacimiento:" "2000-11-30T12:00:00.000Z"}';
let objetoDION = JSON.parse(str_json, function(key,value){
  if(key == "Nacimiento") {
...
console.log(objetoDION);
console.log(objetoDION.nacimiento.getMonth());*/
